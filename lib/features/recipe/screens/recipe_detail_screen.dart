...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  Future<void> _toggleFavorite() async {
    ...
    await RecipeServiceSimple.instance.toggleFavorite(widget.recipe.id!);
                    ...
                    OutlinedButton.icon(
                      onPressed: () async {
                        final confirm = await showDialog<bool>(
                            ...
                            false;
                        if (confirm && recipe.id != null && context.mounted) {
                          await RecipeServiceSimple.instance.softDeleteRecipe(recipe.id!);
